const translations = {
  ...
  "es-pe": {
    ...
    story2025: "Diego pidió la mano a Inés.",
    story2026: "El día en que prometen ser uno para siempre!",
    ...
    transportOwnDesc: "Para que puedan usufruir de la ceremonia y fiestas sin preocupaciones, compartimos el contacto de un coordinador de un equipo de drivers:",
    galleryTitle: "Galería",
    gallerySubtitle: "¡Algunos momentos que forman parte de nuestra historia, desde pequeños hasta hoy!",
    rsvpTitle: "RSVP",
    rsvpSubtitle: "Confirma tu presencia hasta <strong>01 de mayo de 2026</strong> para que podamos preparar todo con detalle y con todo nuestro cariño.",
    rsvpName: "Nombre",
    rsvpGuests: "E-mail",
    ...
    faqScheduleDesc: "Recomendamos que cumplan puntualmente con los horarios establecidos. La novia es la única excepción, como manda la tradición.",
    faqStay: "Alojamiento",
    faqStayDesc: "Hay hoteles cercanos. Escríbenos para sugerencias.",
    giftsTitle: "Regalos",
    giftsSubtitle: "Vuestra presencia es nuestro mayor regalo, y teneros con nosotros hace que este día ya sea inolvidable. Para quien quiera unirse a nosotros de forma aún más especial, dejamos aquí información para contribuir a nuestra casa o a la luna de miel que soñamos vivir juntos, entre Nueva York y Hawái.",
    giftsNote: "Si desean aportar a nuestra nueva etapa, dejamos el IBAN.",
    copyIban: "Copiar",
    copySuccess: "IBAN copiado.",
    giftsThanks: "Gracias por formar parte de nuestra historia.",
