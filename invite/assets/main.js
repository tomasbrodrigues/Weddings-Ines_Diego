const translations = {
  "pt-pt": {
    ...
    story2013: "Inês e Diego conheceram-se nos colégios Fomento (Mira-Rio e Planalto).",
    story2014: "Começaram a namorar cedo demais para saber o que era amar, e o tempo indicou-lhes caminhos diferentes para amadurecer.",
    story2016: "Durante uma década seguiram caminhos distintos, mas a amizade manteve-se firme.",
    ...
    story2025: "Diego pediu Inês em noivado.",
    ...
    programCeremonyDesc: "Receção dos convidados e início da cerimónia religiosa",
    programToast: "Cocktail de Boas-Vindas",
    programToastDesc: "Chegada à Quinta de São Gonçalo",
    programDinner: "Jantar",
    programDinnerDesc: "Porque o amor também se celebra à mesa",
    programParty: "Festa",
    programPartyDesc: "Vamos dançar até amanhecer!",
    programPartyEnd: "Último brinde",
    programPartyEndDesc: "Despedida e boas memórias",
    ...
    transportSubtitle: "A Quinta de São Gonçalo oferece estacionamento a todos os que pretenderem levar carro.",
    transportShuttle: "Transporte organizado",
    transportShuttleDesc: "Será estudado a opção de um autocarro comum. Pedimos que, caso estejam interessados, informem os noivos com brevidade.",
    transportOwn: "Serviço de Drivers",
    transportOwnDesc: "Para que possam usufruir da cerimónia e festas sem preocupações, partilhamos o contacto de um coordenador de uma equipa de drivers:",
    galleryTitle: "Galeria",
    gallerySubtitle: "Alguns momentos que fazem parte da nossa história, desde mais pequenos até hoje!",
    rsvpTitle: "RSVP",
    rsvpSubtitle: "Confirma a tua presença até dia 17 de abril 2026 para que possamos preparar tudo ao detalhe e com todo o nosso carinho.",
    rsvpName: "Nome",
    rsvpGuests: "E-mail",
    ...
    faqDressCodeDesc: "Estamos certos que todos os convidados têm bom gosto, pelo que apenas pedimos que tragam o vosso melhor outfit! Pedimos somente que evitem a cor branca e tons semelhantes.",
    faqKids: "Convidados",
    faqKidsDesc: "O convite já indica as pessoas que contamos ter connosco nesse dia. Agradecemos, por isso, que seja respeitado o nome das pessoas mencionadas no convite, para que tudo decorra como planeado.",
    faqSchedule: "Horários",
    faqScheduleDesc: "Recomendamos que cumpram pontualmente com os horários estipulados. A noiva é a única exceção, como manda a tradição.",
    faqStay: "Alojamento",
    faqStayDesc:
      "Há hotéis parceiros nas proximidades. Contacta-nos para sugestões.",
    giftsTitle: "Presentes",
    giftsSubtitle: "A vossa presença é o nosso maior presente, e tê-los connosco torna este dia já inesquecível. Para quem quiser juntar-se a nós de forma ainda mais especial, deixamos aqui informações para contribuir para a nossa casa ou para a lua de mel que sonhamos viver juntos, entre Nova Iorque e Hawaii.",
    ...
    videoSubtitle: "Como nem todos tiveram a oportunidade de nos acompanhar de perto ao longo deste ano, gostaríamos de vos presentear com um pequeno grande momento que resume o nosso amor e que ditou o início desta consagração matrimonial: o nosso pedido de casamento! Cliquem no play, aumentem o som (o vídeo está em bruto pelo que é possível que se ouça um pouco do maravilhoso discurso que o noivo fez à noiva) e esperemos que se emocionem e gostem tanto como nós ❤️ Até dia 01 de agosto de 2026.",
  ...
  "es-pe": {
    ...
    story2013: "Inés y Diego se conocieron en los colegios Fomento (Mira-Río y Planalto).",
    story2014: "Comenzaron a salir demasiado jóvenes para saber lo que era amar, y el tiempo les indicó caminos diferentes para madurar.",
    story2016: "Durante una década siguieron trayectorias distintas, pero la amistad se mantuvo firme.",
    story2021: "Crecieron y el destino volvió a cruzar sus caminos.",
    story2024: "Compraron la primera casa y abrieron la puerta a la vida que querían compartir.",
    story2025: "Diego le pidió a Inés que se casara con él.",
    story2026: "¡El día en que prometen ser para siempre!",
    ...
    programCeremonyDesc: "Recepción de invitados e inicio de la ceremonia religiosa",
    programToast: "Cóctel de bienvenida",
    programToastDesc: "Llegada a la Quinta de São Gonçalo",
    programDinner: "Cena",
    programDinnerDesc: "Porque el amor también se celebra en la mesa",
    programParty: "Fiesta",
    programPartyDesc: "¡Bailaremos hasta el amanecer!",
    programPartyEnd: "Último brindis",
    ...
    transportTitle: "Transporte",
    transportSubtitle: "La Quinta de São Gonçalo ofrece aparcamiento a cualquiera que desee traer un coche.",
    transportShuttle: "Transporte organizado",
    transportShuttleDesc: "Se considerará la opción de un autobús regular. Si les interesa, por favor, informen a la pareja lo antes posible.",
    transportOwn: "Servicio de drivers",
    transportOwnDesc: "Para garantizar que pueda disfrutar de la ceremonia y las festividades sin preocupaciones, hemos incluido a continuación la información de contacto de un coordinador del equipo de conductores:",
    galleryTitle: "Galería",
    gallerySubtitle: "¡Algunos momentos que forman parte de nuestra historia, desde pequeños hasta hoy!",
    rsvpTitle: "RSVP",
    rsvpSubtitle: "Confirma tu presencia antes del 17 de abril de 2026 para que podamos preparar todo con detalle y con todo nuestro cariño.",
    rsvpName: "Nombre",
    rsvpGuests: "E-mail",
    ...
    faqKids: "Huéspedes",
    faqKidsDesc: "La invitación ya indica las personas que esperamos tener con nosotros ese día. Por lo tanto, agradecemos que se respete el nombre de las personas mencionadas en la invitación, para que todo transcurra como planeado.",
    faqSchedule: "Horarios",
    faqScheduleDesc: "Recomendamos que cumpram pontualmente com os horários estipulados. A noiva é a única exceção, como manda a tradição.",
    faqStay: "Alojamiento",
    faqStayDesc: "Hay hoteles cercanos. Escríbenos para sugerencias.",
    giftsTitle: "Regalos",
    giftsSubtitle: "Su presencia es nuestro mayor regalo, y tenerlos con nosotros hace que este día sea inolvidable. Para quienes deseen acompañarnos de una manera aún más especial, aquí les dejamos información sobre cómo contribuir a nuestro hogar o a la luna de miel que soñamos vivir juntos, entre Nueva York y Hawái.",
    ...
    videoSubtitle: "Como no todos tuvieron la oportunidad de seguirnos de cerca durante este año, queremos compartir con ustedes un pequeño pero significativo momento que resume nuestro amor y marcó el inicio de esta consagración matrimonial: ¡nuestra propuesta de matrimonio! Denle play, suban el volumen (el video está sin editar, así que pueden escuchar un fragmento del maravilloso discurso que el novio le dio a la novia) y esperamos que se emocionen y lo disfruten tanto como nosotros. ❤️ Hasta el 1 de agosto de 2026.",
...
const setupVideoAudioSync = () => {
  ...
  video.addEventListener("volumechange", () => {
    if (video.muted || video.volume === 0) {
      // video became silent — resume background if it was playing before
      resumeBg();
    } else {
      // video is audible — pause background
      pauseBg();
    }
  });
